...
## Theme ------------------------------------
DIR="/home/aaron/.config/hypr"

## Directories ------------------------------
PATH_ALAC="/home/aaron/.config/alacritty"
PATH_ROFI="/home/aaron/.config/rofi"
PATH_WAYB="/home/aaron/.config/waybar"
PATH_WLOG="/home/aaron/.config/wlogout"
PATH_MAKO="/home/aaron/.config/mako"
PATH_GTK3="/home/aaron/.config/gtk-3.0"
PATH_GTK4="/home/aaron/.config/gtk-4.0"
PATH_SPICE="/home/aaron/.config/spicetify"
PATH_OBSIDIAN="$HOME/Nextcloud/Notes/.obsidian/snippets"


## Source Theme File ------------------------
CURRENT_THEME="/home/aaron/.config/hypr/theme/current.bash"
DEFAULT_THEME="/home/aaron/.config/hypr/theme/default.bash"
...
source_pywal() {
	...
	modbackground=(`pastel gradient -n 3 $background $altbackground | pastel format hex`)
	accent="$color4"
		color0="`pastel color $color0 | pastel mix -f 0.3 black | pastel format hex`"
		color1="`pastel color $color1 | pastel mix -f 0.3 red | pastel format hex`"
		color2="`pastel color $color2 | pastel mix -f 0.3 green | pastel format hex`"
		color3="`pastel color $color3 | pastel mix -f 0.3 yellow | pastel format hex`"
		color4="`pastel color $color4 | pastel mix -f 0.3 blue | pastel format hex`"
		color5="`pastel color $color5 | pastel mix -f 0.3 magenta | pastel format hex`"
		color6="`pastel color $color6 | pastel mix -f 0.3 cyan | pastel format hex`"
		color7="`pastel color $color7 | pastel mix -f 0.3 white | pastel format hex`"
		color8="`pastel color $color8 | pastel lighten 0.20 | pastel mix -f 0.3 black | pastel format hex`"
		color9="`pastel color $color9 | pastel lighten 0.20 | pastel mix -f 0.3 red | pastel format hex`"
		color10="`pastel color $color10 | pastel lighten 0.20 | pastel mix -f 0.3 green | pastel format hex`"
		color11="`pastel color $color11 | pastel lighten 0.20 | pastel mix -f 0.3 yellow | pastel format hex`"
		color12="`pastel color $color12 | pastel lighten 0.20 | pastel mix -f 0.3 blue | pastel format hex`"
		color13="`pastel color $color13 | pastel lighten 0.20 | pastel mix -f 0.3 magenta | pastel format hex`"
		color14="`pastel color $color14 | pastel lighten 0.20 | pastel mix -f 0.3 cyan | pastel format hex`"
		color15="`pastel color $color15 | pastel lighten 0.20 | pastel mix -f 0.3 white | pastel format hex`"
}
...
apply_startpage() {
	cp $HOME/.cache/wal/colors.css /home/aaron/.config/startpage/colors.css
}
